<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <String label="Require" v-model="value.require" :editMode="editMode"/>
            <Money offline label="Price" v-model="value.price" :editMode="editMode" @change="change"/>
            <Boolean label="IsPaid" v-model="value.isPaid" :editMode="editMode"/>
        </v-card-text>
        ...
        <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn  
                    :disabled="!userRoles.includes('Customer')"
                    v-if="!editMode"
                    color="deep-purple lighten-2"
                    text
                    @click="cancelOrder"
